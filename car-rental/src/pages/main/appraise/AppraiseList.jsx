...
export default function AppraiseList() {
        ...
        },
        {
            ...
            render: (item) => {
                ...
                return <div>
                    ...
                    &nbsp;
                    {
                        (name === item.author || roleId <= 2) &&
                        <Button type='primary' danger onClick={() => toConfirm(item)}>删除</Button>
                    }
                </div>
            }
        },
    ...
    const newComment = async () => {
        if (content === "" || content.trim() === "<p><br></p>" || content.trim() === "<p></p>") {
            ...
            axios.get(`/comments/${evaluateDetail.id}`).then(res => {
                console.log(res.data)
                setCommentsList(res.data.data)
            })
            setcontent("")
    ...
    return (
        <div>
            <AppraiseDetail setisappraise={setisappraise} isappraise={isappraise} evaluatesDetail={evaluateDetail}
